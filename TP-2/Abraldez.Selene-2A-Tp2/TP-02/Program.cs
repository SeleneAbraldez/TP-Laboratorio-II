...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Nombre del alumno
            Console.Title = "Selene Abraldez 2A";
...
//cambie de orden el mostrar primero solo las leches y despues solo los dulces porque en el exe funcional estaban asi, para que fuera mas facil corroborar el funcionamiento identico